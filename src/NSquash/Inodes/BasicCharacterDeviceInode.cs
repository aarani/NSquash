...
internal class BasicCharacterDeviceInode : Inode
{
    public BasicCharacterDeviceInode(uint blockSize, ReadOnlyMemory<byte> data) : base(blockSize, data)
    {
    ...
    public override uint GetTypeIdentifier() => 5;
