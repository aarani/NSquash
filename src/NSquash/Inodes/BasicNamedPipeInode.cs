...
internal class BasicNamedPipeInode : Inode
{
    public BasicNamedPipeInode(uint blockSize, ReadOnlyMemory<byte> data) : base(blockSize, data)
    {
    ...
    public override uint GetTypeIdentifier() => 6;
    protected override int GetSpecialMetadataLength() => 4;
