...
internal class ExtendedSocketInode : Inode
{
    public ExtendedSocketInode(uint blockSize, ReadOnlyMemory<byte> data) : base(blockSize, data)
    {
    ...
    public override uint GetTypeIdentifier() => 14;
