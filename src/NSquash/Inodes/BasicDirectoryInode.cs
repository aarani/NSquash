...
internal class BasicDirectoryInode : Inode
{
    public BasicDirectoryInode(uint blockSize, ReadOnlyMemory<byte> data) : base(blockSize, data)
    {
    ...
    public override uint GetTypeIdentifier() => 1;

    protected override int GetSpecialMetadataLength() => 16;
