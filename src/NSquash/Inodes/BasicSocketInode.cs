...
internal class BasicSocketInode : Inode
{
    public BasicSocketInode(uint blockSize, ReadOnlyMemory<byte> data) : base(blockSize, data)
    {
    ...
    public override uint GetTypeIdentifier() => 7;
